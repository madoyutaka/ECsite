...
<html>
	...
	<body>
		...
		氏名(20文字以内)<input type="text" name="userName"   maxlength='20' placeholder="山田 太郎"><br><br>

		ユーザーID(20文字以内)<input type="text" name="userId"  maxlength='20' placeholder="tarou"><br><br>

		パスワード(20文字以内)<input type="password" name="password"   maxlength='20'  placeholder="tarou12345678"><br><br>

		メールアドレス(40文字以内)<input type="text" name="emailAddress"  maxlength='40' placeholder="tarou@mail"><br><br>

		郵便番号(ハイフンなし半角数字7桁)<input type="text" name="postalCode" size="5"  maxlength='7' placeholder="1112222"><br><br>
